...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // TODOne (04) Setup the LiveData observation relationship by getting the LiveData from your
    ...
    // TODOne (05) Move this code to update the UI up to your Observers; remove references to
